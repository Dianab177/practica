<!--Solución Propuesta Ejercicio 3.1.5-->
...
<!--En esta ocasión es necesario crear un nuevo formulario en la página, 
en la sección donde se muestra el número de unidades por tienda. 
Revisa el código de la solución y pruebalo.-->
...
//hemos enviado el formulario para consultar las unidades
                ...
                if (!($stmt->prepare($consulta)) || !($stmt1->prepare($consulta1))) {
                    die("Se ha producido un error " . $conProyecto->error);
                }
